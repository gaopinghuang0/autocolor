...
(function($) {
$.fn.autocolor = function(settings){
	...
	$this.bind('change paste keyup', function(){
		...
		emulator.css("height",config.height);
		emulator.css("width",config.width);
		var color_value = $(this).val().toLowerCase();
		if (typeof colors[color_value] != 'undefined') {	
			emulator.css('background',colors[color_value]);
		}
	});
}
})(jQuery);